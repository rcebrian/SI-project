...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scroll_ref_articles_items.setGeometry(QtCore.QRect(0, 0, 353, 251))
        ...
        self.tx_compare_preview.setReadOnly(True)
        ...
        self.scroll_res_rank_items.setGeometry(QtCore.QRect(0, 0, 388, 251))
        ...
        self.tx_compare_article.setReadOnly(True)
        ...
        self.tag_rec = QtWidgets.QWidget()
        self.tag_rec.setObjectName("tag_rec")
        self.horizontalLayout_13 = QtWidgets.QHBoxLayout(self.tag_rec)
        self.horizontalLayout_13.setObjectName("horizontalLayout_13")
        self.gb_references_2 = QtWidgets.QGroupBox(self.tag_rec)
        self.gb_references_2.setObjectName("gb_references_2")
        self.verticalLayout_13 = QtWidgets.QVBoxLayout(self.gb_references_2)
        self.verticalLayout_13.setObjectName("verticalLayout_13")
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.verticalLayout_14 = QtWidgets.QVBoxLayout()
        self.verticalLayout_14.setObjectName("verticalLayout_14")
        self.HL_search_3 = QtWidgets.QHBoxLayout()
        self.HL_search_3.setObjectName("HL_search_3")
        self.lbl_reco_ref_source = QtWidgets.QLabel(self.gb_references_2)
        self.lbl_reco_ref_source.setObjectName("lbl_reco_ref_source")
        self.HL_search_3.addWidget(self.lbl_reco_ref_source)
        self.cb_reco_ref_source = QtWidgets.QComboBox(self.gb_references_2)
        self.cb_reco_ref_source.setObjectName("cb_reco_ref_source")
        self.cb_reco_ref_source.addItem("")
        self.cb_reco_ref_source.addItem("")
        self.cb_reco_ref_source.addItem("")
        self.cb_reco_ref_source.addItem("")
        self.HL_search_3.addWidget(self.cb_reco_ref_source)
        self.verticalLayout_14.addLayout(self.HL_search_3)
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.lbl_reco_ref_cat = QtWidgets.QLabel(self.gb_references_2)
        self.lbl_reco_ref_cat.setObjectName("lbl_reco_ref_cat")
        self.horizontalLayout_10.addWidget(self.lbl_reco_ref_cat)
        self.cb_reco_ref_cat = QtWidgets.QComboBox(self.gb_references_2)
        self.cb_reco_ref_cat.setMinimumSize(QtCore.QSize(50, 0))
        self.cb_reco_ref_cat.setObjectName("cb_reco_ref_cat")
        self.cb_reco_ref_cat.addItem("")
        self.cb_reco_ref_cat.addItem("")
        self.cb_reco_ref_cat.addItem("")
        self.cb_reco_ref_cat.addItem("")
        self.horizontalLayout_10.addWidget(self.cb_reco_ref_cat)
        self.verticalLayout_14.addLayout(self.horizontalLayout_10)
        self.horizontalLayout_14 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_14.setObjectName("horizontalLayout_14")
        self.lbl_reco_ref_cat_6 = QtWidgets.QLabel(self.gb_references_2)
        self.lbl_reco_ref_cat_6.setObjectName("lbl_reco_ref_cat_6")
        self.horizontalLayout_14.addWidget(self.lbl_reco_ref_cat_6)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_14.addItem(spacerItem1)
        self.sim_percent = QtWidgets.QLineEdit(self.gb_references_2)
        self.sim_percent.setMaximumSize(QtCore.QSize(50, 16777215))
        self.sim_percent.setObjectName("sim_percent")
        self.horizontalLayout_14.addWidget(self.sim_percent)
        self.lbl_reco_ref_cat_7 = QtWidgets.QLabel(self.gb_references_2)
        self.lbl_reco_ref_cat_7.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lbl_reco_ref_cat_7.setObjectName("lbl_reco_ref_cat_7")
        self.horizontalLayout_14.addWidget(self.lbl_reco_ref_cat_7)
        self.verticalLayout_14.addLayout(self.horizontalLayout_14)
        self.horizontalLayout_7.addLayout(self.verticalLayout_14)
        self.VL_ref_articles_2 = QtWidgets.QVBoxLayout()
        self.VL_ref_articles_2.setObjectName("VL_ref_articles_2")
        self.lbl_reco_prev_articles = QtWidgets.QLabel(self.gb_references_2)
        self.lbl_reco_prev_articles.setObjectName("lbl_reco_prev_articles")
        self.VL_ref_articles_2.addWidget(self.lbl_reco_prev_articles)
        self.scroll_ref_articles_2 = QtWidgets.QScrollArea(self.gb_references_2)
        self.scroll_ref_articles_2.setWidgetResizable(True)
        self.scroll_ref_articles_2.setObjectName("scroll_ref_articles_2")
        self.scroll_reco_ref_articles_items = QtWidgets.QWidget()
        self.scroll_reco_ref_articles_items.setGeometry(QtCore.QRect(0, 0, 274, 251))
        self.scroll_reco_ref_articles_items.setObjectName("scroll_reco_ref_articles_items")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.scroll_reco_ref_articles_items)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.table_reco_ref_articles = QtWidgets.QTableWidget(self.scroll_reco_ref_articles_items)
        self.table_reco_ref_articles.setMaximumSize(QtCore.QSize(16777215, 250))
        self.table_reco_ref_articles.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.table_reco_ref_articles.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.table_reco_ref_articles.setDragEnabled(True)
        self.table_reco_ref_articles.setAlternatingRowColors(True)
        self.table_reco_ref_articles.setShowGrid(False)
        self.table_reco_ref_articles.setObjectName("table_reco_ref_articles")
        self.table_reco_ref_articles.setColumnCount(0)
        self.table_reco_ref_articles.setRowCount(0)
        self.table_reco_ref_articles.horizontalHeader().setVisible(False)
        self.table_reco_ref_articles.horizontalHeader().setHighlightSections(False)
        self.table_reco_ref_articles.horizontalHeader().setStretchLastSection(True)
        self.table_reco_ref_articles.verticalHeader().setVisible(False)
        self.horizontalLayout_3.addWidget(self.table_reco_ref_articles)
        self.scroll_ref_articles_2.setWidget(self.scroll_reco_ref_articles_items)
        self.VL_ref_articles_2.addWidget(self.scroll_ref_articles_2)
        self.horizontalLayout_7.addLayout(self.VL_ref_articles_2)
        self.verticalLayout_13.addLayout(self.horizontalLayout_7)
        self.lbl_reco_ref_preview = QtWidgets.QLabel(self.gb_references_2)
        self.lbl_reco_ref_preview.setObjectName("lbl_reco_ref_preview")
        self.verticalLayout_13.addWidget(self.lbl_reco_ref_preview)
        self.tx_reco_preview = QtWidgets.QTextEdit(self.gb_references_2)
        self.tx_reco_preview.setReadOnly(True)
        self.tx_reco_preview.setObjectName("tx_reco_preview")
        self.verticalLayout_13.addWidget(self.tx_reco_preview)
        self.horizontalLayout_13.addWidget(self.gb_references_2)
        self.gb_rec_results = QtWidgets.QGroupBox(self.tag_rec)
        self.gb_rec_results.setObjectName("gb_rec_results")
        self.verticalLayout_15 = QtWidgets.QVBoxLayout(self.gb_rec_results)
        self.verticalLayout_15.setObjectName("verticalLayout_15")
        self.HL_results_2 = QtWidgets.QHBoxLayout()
        self.HL_results_2.setObjectName("HL_results_2")
        self.VL_reco_rank = QtWidgets.QVBoxLayout()
        self.VL_reco_rank.setObjectName("VL_reco_rank")
        self.lbl_reco_rank = QtWidgets.QLabel(self.gb_rec_results)
        self.lbl_reco_rank.setObjectName("lbl_reco_rank")
        self.VL_reco_rank.addWidget(self.lbl_reco_rank)
        self.scroll_reco_rank = QtWidgets.QScrollArea(self.gb_rec_results)
        self.scroll_reco_rank.setWidgetResizable(True)
        self.scroll_reco_rank.setObjectName("scroll_reco_rank")
        self.scroll_reco_rank_items = QtWidgets.QWidget()
        self.scroll_reco_rank_items.setGeometry(QtCore.QRect(0, 0, 557, 251))
        self.scroll_reco_rank_items.setObjectName("scroll_reco_rank_items")
        self.verticalLayout_16 = QtWidgets.QVBoxLayout(self.scroll_reco_rank_items)
        self.verticalLayout_16.setObjectName("verticalLayout_16")
        self.table_reco_ref_rank = QtWidgets.QTableWidget(self.scroll_reco_rank_items)
        self.table_reco_ref_rank.setMaximumSize(QtCore.QSize(16777215, 250))
        self.table_reco_ref_rank.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.table_reco_ref_rank.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.table_reco_ref_rank.setDragEnabled(True)
        self.table_reco_ref_rank.setAlternatingRowColors(True)
        self.table_reco_ref_rank.setShowGrid(False)
        self.table_reco_ref_rank.setObjectName("table_reco_ref_rank")
        self.table_reco_ref_rank.setColumnCount(0)
        self.table_reco_ref_rank.setRowCount(0)
        self.table_reco_ref_rank.horizontalHeader().setVisible(False)
        self.table_reco_ref_rank.horizontalHeader().setHighlightSections(False)
        self.table_reco_ref_rank.horizontalHeader().setStretchLastSection(True)
        self.table_reco_ref_rank.verticalHeader().setVisible(False)
        self.verticalLayout_16.addWidget(self.table_reco_ref_rank)
        self.scroll_reco_rank.setWidget(self.scroll_reco_rank_items)
        self.VL_reco_rank.addWidget(self.scroll_reco_rank)
        self.HL_results_2.addLayout(self.VL_reco_rank)
        self.verticalLayout_15.addLayout(self.HL_results_2)
        self.lbl_result_article_2 = QtWidgets.QLabel(self.gb_rec_results)
        self.lbl_result_article_2.setObjectName("lbl_result_article_2")
        self.verticalLayout_15.addWidget(self.lbl_result_article_2)
        self.tx_reco_article = QtWidgets.QTextEdit(self.gb_rec_results)
        self.tx_reco_article.setReadOnly(True)
        self.tx_reco_article.setObjectName("tx_reco_article")
        self.verticalLayout_15.addWidget(self.tx_reco_article)
        self.horizontalLayout_13.addWidget(self.gb_rec_results)
        self.tabWidget.addTab(self.tag_rec, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cb_top.setItemText(6, _translate("MainWindow", "6"))
        self.cb_top.setItemText(7, _translate("MainWindow", "7"))
        self.cb_top.setItemText(8, _translate("MainWindow", "8"))
        self.cb_top.setItemText(9, _translate("MainWindow", "9"))
        self.cb_top.setItemText(10, _translate("MainWindow", "10"))
        self.cb_top.setItemText(11, _translate("MainWindow", "11"))
        self.cb_top.setItemText(12, _translate("MainWindow", "12"))
        self.cb_top.setItemText(13, _translate("MainWindow", "13"))
        self.cb_top.setItemText(14, _translate("MainWindow", "14"))
        self.cb_top.setItemText(15, _translate("MainWindow", "15"))
        self.cb_top.setItemText(16, _translate("MainWindow", "16"))
        self.cb_top.setItemText(17, _translate("MainWindow", "17"))
        self.cb_top.setItemText(18, _translate("MainWindow", "18"))
        self.cb_top.setItemText(19, _translate("MainWindow", "19"))
        self.cb_top.setItemText(20, _translate("MainWindow", "20"))
        ...
        self.cb_res_top.setItemText(6, _translate("MainWindow", "6"))
        self.cb_res_top.setItemText(7, _translate("MainWindow", "7"))
        self.cb_res_top.setItemText(8, _translate("MainWindow", "8"))
        self.cb_res_top.setItemText(9, _translate("MainWindow", "9"))
        self.cb_res_top.setItemText(10, _translate("MainWindow", "10"))
        self.cb_res_top.setItemText(11, _translate("MainWindow", "11"))
        self.cb_res_top.setItemText(12, _translate("MainWindow", "12"))
        self.cb_res_top.setItemText(13, _translate("MainWindow", "13"))
        self.cb_res_top.setItemText(14, _translate("MainWindow", "14"))
        self.cb_res_top.setItemText(15, _translate("MainWindow", "15"))
        self.cb_res_top.setItemText(16, _translate("MainWindow", "16"))
        self.cb_res_top.setItemText(17, _translate("MainWindow", "17"))
        self.cb_res_top.setItemText(18, _translate("MainWindow", "18"))
        self.cb_res_top.setItemText(19, _translate("MainWindow", "19"))
        self.cb_res_top.setItemText(20, _translate("MainWindow", "20"))
        ...
        self.gb_references_2.setTitle(_translate("MainWindow", "Reference"))
        self.lbl_reco_ref_source.setText(_translate("MainWindow", "Source"))
        self.cb_reco_ref_source.setItemText(0, _translate("MainWindow", "All Sources"))
        self.cb_reco_ref_source.setItemText(1, _translate("MainWindow", "20 Minutos"))
        self.cb_reco_ref_source.setItemText(2, _translate("MainWindow", "El Mundo"))
        self.cb_reco_ref_source.setItemText(3, _translate("MainWindow", "El Pais"))
        self.lbl_reco_ref_cat.setText(_translate("MainWindow", "Category"))
        self.cb_reco_ref_cat.setItemText(0, _translate("MainWindow", "All Categories"))
        self.cb_reco_ref_cat.setItemText(1, _translate("MainWindow", "Health"))
        self.cb_reco_ref_cat.setItemText(2, _translate("MainWindow", "Science"))
        self.cb_reco_ref_cat.setItemText(3, _translate("MainWindow", "Technology"))
        self.lbl_reco_ref_cat_6.setText(_translate("MainWindow", "Similarity"))
        self.sim_percent.setText(_translate("MainWindow", "10"))
        self.lbl_reco_ref_cat_7.setText(_translate("MainWindow", "%"))
        self.lbl_reco_prev_articles.setText(_translate("MainWindow", "Articles"))
        self.lbl_reco_ref_preview.setText(_translate("MainWindow", "Preview"))
        self.gb_rec_results.setTitle(_translate("MainWindow", "Results"))
        self.lbl_reco_rank.setText(_translate("MainWindow", "Ranking"))
        self.lbl_result_article_2.setText(_translate("MainWindow", "Article"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tag_rec), _translate("MainWindow", "Recommendations"))
